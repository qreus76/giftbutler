    ...
    <main className="min-h-screen bg-stone-50">
      <div className="max-w-xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-stone-900">{profile?.name || username}</h1>
        ...
        {!showFinder && (
          ...
          >
            Find the perfect gift for {profile?.name || username} →
          </button>
        )}
        ...
        {recommendations.length > 0 && (
          <div className="mb-6">
            <h2 className="font-bold text-stone-900 mb-3">Gift ideas for {profile?.name || username}</h2>
