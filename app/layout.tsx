    ...
    <ClerkProvider
      appearance={{
        ...
        elements: {
          ...
          socialButtonsBlockButton: "border-stone-200 hover:bg-stone-50 text-stone-700 font-semibold rounded-xl !py-3",
          formButtonPrimary: "bg-amber-400 hover:bg-amber-500 text-stone-900 font-bold rounded-xl shadow-none !py-3",
          formFieldInput: "border-stone-200 rounded-xl focus:ring-amber-400 !py-2.5 !px-4",
